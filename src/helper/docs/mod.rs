...
fn get_selection_theme() -> ColorfulTheme {
    ColorfulTheme {
        ...
        prompt_prefix: style("(ï¾Â´ã®`)ï¾*: ï½¥ï¾\n".to_string()).for_stderr().magenta(),
        prompt_suffix: style("âº".to_string()).for_stderr().magenta().bright(),
        success_prefix: style("â¤".to_string()).for_stderr().magenta(),
        success_suffix: style("Â·".to_string()).for_stderr().black().bright(),
        error_prefix: style("â".to_string()).for_stderr().red(),
        error_style: Style::new().for_stderr().red(),
        hint_style: Style::new().for_stderr().black().bright(),
        values_style: Style::new().for_stderr().green(),
        active_item_style: Style::new().for_stderr().green().bold(),
        inactive_item_style: Style::new().for_stderr().italic(),
        active_item_prefix: style("â§".to_string()).for_stderr().magenta().bold(),
        inactive_item_prefix: style(" ".to_string()).for_stderr(),
        checked_item_prefix: style("â¤".to_string()).for_stderr().magenta(),
        unchecked_item_prefix: style("â¤".to_string()).for_stderr().black(),
        picked_item_prefix: style("â¯".to_string()).for_stderr().green(),
